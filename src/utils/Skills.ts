export const developerSkills = {
	program: [
		...
		{ name: ["C"], year: 2022, month: 3 },
		{ name: ["Bash"], year: 2022, month: 3 },

		{ name: ["Git(LFS)"], year: 2020, month: 8 },
		{ name: ["React"], year: 2021, month: 8 },
		{
...
export const aboutMe = {
	...
	otherSkills: ["UI/UX", "Blockchain savvy", "Microsoft Suite", "Notion"],
	hobbies: [
		"New tech",
		"Football",
		"Design & Conception",
